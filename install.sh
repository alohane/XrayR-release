...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://zero.fuzzypn.me/download/xrayr_stable.zip
        if [[ $? -ne 0 ]]; then
        ...
        url="https://zero.fuzzypn.me/download/xrayr_stable.zip"
